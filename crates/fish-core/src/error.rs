...
impl RecoveryStrategy {
    pub fn from_error(error: &FishError) -> Self {
        match error.kind {
...
/// Result type alias for Fish operations
...
mod tests {
    ...
    #[test]
    fn test_fish_error_creation() {
        let error = FishError::new(
    ...
    fn test_recovery_strategy_selection() {
        let recoverable_error = FishError::new(
            ErrorKind::Recoverable("Temporary failure".to_string()),
