...
#[derive(Parser, Debug)]
#[command(name = "fish-setup", version, about = "Fish Build System Installer")]
struct CliArgs {
    ...
    #[arg(long, help = "Uninstall Fish from the system")]
    uninstall: bool,
...
fn main() {
    ...
    let source_bin = install::find_source_fish_binary();
