...
use forge_backend_cc::{CcBackend, CcLanguage, CcOutputType, CcProjectConfig};
...
use forge_incremental::ecosystem::{EcosystemInfo, EcosystemType, detect_ecosystems};
...
impl PolyglotGraphBuilder {
    ...
    fn build_subgraph_for_ecosystem(
        ...
        match info.ecosystem {
            ...
            EcosystemType::Cpp => {
                let config_path = dir.join("forge.cc.json");
                let config = if config_path.exists() {
