...
impl Messages {
    pub fn get(lang: Language) -> Self {
        match lang {
            Language::En => Self {
                welcome_banner: "=== Welcome to Forge Build System Installer ===",
                ...
                path_addition: "Adding Forge to User PATH environment variable...",
                path_added: "Successfully added Forge to PATH.",
                path_already_present: "Forge is already in your PATH.",
                installing_binaries: "Copying Forge executable files...",
                ...
                uninstall_confirm: "Are you sure you want to uninstall Forge? (y/N):",
                uninstall_complete: "Forge has been successfully uninstalled.",
                uninstall_path_removed: "Removed Forge from User PATH environment variable.",
                next_steps: "Open a new terminal and run 'forge --help' to start building!",
                press_enter_to_exit: "Press Enter to exit...",
            },
            Language::Vi => Self {
                welcome_banner: "=== Chào mừng đến với Trình Cài Đặt Forge Build System ===",
                ...
                path_addition: "Đang thêm Forge vào biến môi trường PATH của người dùng...",
                path_added: "Đã thêm Forge vào PATH thành công.",
                path_already_present: "Forge đã có sẵn trong PATH.",
                installing_binaries: "Đang sao chép các tệp thực thi Forge...",
                ...
                uninstall_confirm: "Bạn có chắc chắn muốn gỡ cài đặt Forge? (y/N):",
                uninstall_complete: "Forge đã được gỡ cài đặt hoàn toàn.",
                uninstall_path_removed: "Đã xóa Forge khỏi biến môi trường PATH của người dùng.",
                next_steps: "Hãy mở cửa sổ Terminal mới và gõ lệnh 'forge --help' để bắt đầu!",
                press_enter_to_exit: "Nhấn Enter để thoát...",
            },
            Language::ZhCn => Self {
                welcome_banner: "=== 欢迎使用 Forge 构建系统安装程序 ===",
                select_language: "请选择您的语言：",
                install_location: "安装目录：",
                enter_custom_path: "输入自定义安装路径（直接按回车使用默认路径）：",
                path_addition: "正在将 Forge 添加到用户 PATH 环境变量...",
                path_added: "已成功将 Forge 添加到 PATH。",
                path_already_present: "Forge 已存在于您的 PATH 中。",
                installing_binaries: "正在复制 Forge 可执行文件...",
                installation_complete: "安装已成功完成！",
                toolchains_header: "正在检测已安装的语言工具链：",
                toolchain_found: "已检测到",
                toolchain_not_found: "未找到",
                uninstall_confirm: "您确定要卸载 Forge 吗？(y/N):",
                uninstall_complete: "Forge 已成功卸载。",
                uninstall_path_removed: "已从用户 PATH 环境变量中移除 Forge。",
                next_steps: "打开新的终端并运行 'forge --help' 即可开始！",
                press_enter_to_exit: "按回车键退出...",
            },
            Language::ZhTw => Self {
                welcome_banner: "=== 歡迎使用 Forge 構建系統安裝程式 ===",
                select_language: "請選擇您的語言：",
                install_location: "安裝目錄：",
                enter_custom_path: "輸入自訂安裝路徑（直接按 Enter 使用預設路徑）：",
                path_addition: "正在將 Forge 新增至使用者 PATH 環境變數...",
                path_added: "已成功將 Forge 新增至 PATH。",
                path_already_present: "Forge 已存在於您的 PATH 中。",
                installing_binaries: "正在複製 Forge 執行檔...",
                installation_complete: "安裝已成功完成！",
                toolchains_header: "正在檢測已安裝的語言工具鏈：",
                toolchain_found: "已檢測到",
                toolchain_not_found: "未找到",
                uninstall_confirm: "您確定要解除安裝 Forge 嗎？(y/N):",
                uninstall_complete: "Forge 已成功解除安裝。",
                uninstall_path_removed: "已從使用者 PATH 環境變數中移除 Forge。",
                next_steps: "開啟新的終端機並執行 'forge --help' 即可開始！",
                press_enter_to_exit: "按 Enter 鍵結束...",
            },
            Language::Ja => Self {
                welcome_banner: "=== Forge ビルドシステム インストーラーへようこそ ===",
                select_language: "言語を選択してください：",
                install_location: "インストール先ディレクトリ：",
                enter_custom_path: "カスタムインストール先を入力してください（既定値を使用する場合はEnter）：",
                path_addition: "Forge をユーザー PATH 環境変数に追加しています...",
                path_added: "Forge が PATH に正常に追加されました。",
                path_already_present: "Forge はすでに PATH に設定されています。",
                installing_binaries: "Forge 実行可能ファイルを配置しています...",
                ...
                uninstall_confirm: "Forge をアンインストールしてもよろしいですか？ (y/N):",
                uninstall_complete: "Forge のアンインストールが完了しました。",
                uninstall_path_removed: "ユーザー PATH 環境変数から Forge を削除しました。",
