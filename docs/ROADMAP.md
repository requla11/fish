...
- [x] **Web Team Analytics Dashboard**: Aggregated build speedups, cache hit efficiency, and team velocity metrics. *(The `fish ui` HTTP server in `crates/fish-cli/src/commands/ui.rs` serves the interactive graph and telemetry endpoints.)*
