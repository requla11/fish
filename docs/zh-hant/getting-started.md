...
> 🌐 **翻译与贡献：** 想用您的语言翻译或改进本文档？请參閱我们的 [翻译指南](TRANSLATION.md)。
...
完整配置项请參閱 [配置指南](configuration.md)。

---

## 交互式遥测与 Web 儀表板

Fish 内置了实时交互式 DAG 可视化分析工具与 Web 儀表板，支持 5 种语言（英语、越南语、簡體中文、繁體中文、日語）：

```bash
# 在 3000 端口启动 Web 儀表板并自动在瀏覽器中打开
...
1. 检查错误信息或运行 `fish build --explain` 诊断重新編譯原因。
